...
def get_data():
    ...
    for i in range(pages_count):
        ...
        response = s.post('https://www.mvideo.ru/bff/product-details/list', headers=headers, json=json_data).json()
        ...
        response = s.get('https://www.mvideo.ru/bff/products/prices', params=params, headers=headers).json()
